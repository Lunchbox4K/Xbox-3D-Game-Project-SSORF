...
using SSORF.Management.States;

namespace SSORF.Management
{
    /// <summary>
    /// This keeps track of what sounds are playing, updating
    /// their settings as the camera and entities move around the level, and
    ...
    public class AudioManager : Microsoft.Xna.Framework.GameComponent
    {
        ...
        // List of all the sound effects that we will use
        ...
        // Keep track of all the sounds that are currently playing.
